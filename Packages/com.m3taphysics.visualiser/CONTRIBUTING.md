...
1. Make an [Issue](https://github.com/m3taphysics/Arch.SystemGroups.Visualiser/issues/new)
...
```json
    {
        "dependencies": {
            "com.m3taphysics.Arch.SystemGroups.Visualiser": "https://github.com/YOUR_USER/Arch.SystemGroups.Visualiser.git"
        }
    }
```
...
reported to the community leaders responsible for enforcement at ashley.canning@gmail.com.
